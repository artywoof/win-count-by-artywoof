...
<div class="w-full h-full relative">
  <div class="w-full h-full relative">
      ...
      <div class="absolute top-5 left-5 z-50">
        <button on:click={() => appWindow.minimize()} class="w-8 h-8 bg-blue-600 text-white rounded-lg shadow-[0_0_8px_#0066ff] hover:shadow-[0_0_16px_#0066ff] hover:bg-blue-500 transition-all no-drag flex items-center justify-center" style="-webkit-app-region: no-drag; text-shadow: 0 0 4px #fff;">
      ...
      <!-- Header - "PRESET" -->
      <h1 class="absolute top-[60px] left-1/2 transform -translate-x-1/2 font-bold text-[40px]" style="-webkit-app-region: drag; color: #ff00cc !important; text-shadow: 0 0 8px #ff00cc, 0 0 16px #ff00cc, 0 0 24px #ff00cc !important;">
        PRESET
      </h1>

      <!-- Icon + Number Box Container -->
      <div class="absolute top-[120px] left-1/2 transform -translate-x-1/2 w-[450px] h-[120px] rounded-lg border border-blue-500 shadow-[0_0_12px_#0066ff44] p-4">
        <div class="flex gap-4 h-full">
          ...
          <div class="w-[180px] h-full rounded-lg border border-yellow-400 shadow-[0_0_8px_#ffff0044] flex items-center justify-center">
            <img src="/assets/ui/app_crown.png" alt="Crown Icon" class="w-[60px] h-[60px] object-contain" />
          </div>
          {/if}
      ...
      <!-- GOAL Label + Input -->
      <div class="absolute top-[260px] left-1/2 transform -translate-x-1/2 w-[450px] h-[55px] rounded-lg border border-blue-500 shadow-[0_0_8px_#0066ff44] flex items-center px-6">
        <label for="goal-input" class="text-[20px] font-bold mr-6" style="color: #ff00cc !important; text-shadow: 0 0 8px #ff00cc, 0 0 16px #ff00cc !important;">GOAL:</label>
        <input 
          id="goal-input"
      ...
      <!-- PRESET Button -->
      <div class="absolute top-[335px] left-1/2 transform -translate-x-1/2">
        <button
          class="w-[450px] h-[55px] rounded-lg border border-pink-500 font-bold text-[22px] shadow-[0_0_12px_#ff00cc44] bg-transparent hover:bg-pink-500 hover:text-white transition-all no-drag"
      ...
      <div class="absolute bottom-[120px] left-1/2 transform -translate-x-1/2 w-[450px] h-[160px] rounded-lg border border-purple-500 shadow-[0_0_12px_#8b5cf644] py-8 px-6 flex items-center">
        <div class="flex flex-col gap-10 w-full">
          <div class="flex justify-between items-center">
            <!-- svelte-ignore a11y_label_has_associated_control -->
            <label class="text-[20px] font-bold" style="color: #ff00cc !important; text-shadow: 0 0 8px #ff00cc, 0 0 16px #ff00cc !important;">ICON</label>
            <button
          ...
          <div class="flex justify-between items-center">
            <span class="text-[20px] font-bold" style="color: #ff00cc !important; text-shadow: 0 0 8px #ff00cc, 0 0 16px #ff00cc !important;">GOAL</span>
            <button
