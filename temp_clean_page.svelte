...
<style>
  ...
  .counter-content {
    display: flex;
    align-items: stretch; /* เปลี่ยนจาก center เป็น stretch */
    justify-content: center;
    gap: 0px;
    height: 100%;
  }
  ...
  .crown-container {
    ...
    align-items: center;
    justify-content: center;
    width: 110px; /* ลดขนาดให้ใกล้กับกล่องตัวเลข */
    height: 102px; /* เท่ากับ win-number-container */
    margin-right: 4px;
  }
  ...
  .win-number {
    ...
    height: 100%;
    display: flex;
    align-items: flex-end; /* ขยับตัวเลขลงล่าง */
    justify-content: center;
    padding-bottom: 10px; /* เพิ่มระยะห่างจากขอบล่างเพื่อให้อยู่กลางกล่องจริง */
  }
